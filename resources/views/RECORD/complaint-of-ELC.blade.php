  ...
  <div class="col-md-12 main-datatable">
    <div class="card-body" >
       ...
       <div class="table-responsive">
         <table id="filltertabless" class="table  table-bordered table-hover  caption-top textcenter dataTable ">
             <thead class="table-light">
               <tr>
                 <th style="width: 5px;">م</th>
                 <th style="width: 130px;">رقم القيد</th>
                 <th style="width: 240px;">الاسم</th>
                 <th style="width: 70px;"> المستوى </th>
                 <th style="width: 100px;">اسم المادة </th>
                 <th style="width: 80px;"> الدرجة الحالية </th>
                 <th style="width: 20px;">نوع التظلم </th>
                 <th style="width: 70px;">صورة السند  </th>
               </tr>
             </thead>
             <tbody>     
                 <tr class="even">
