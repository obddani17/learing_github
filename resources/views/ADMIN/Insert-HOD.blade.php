                ...
                <div class="col-4">
                      <div class="card shadow mb-4">
                        <div class="card-header">
                          <strong class="card-title"> بيانات رئيس القسم</strong>
                        </div>
                        <div class="card-body">
                          <form class="needs-validation" novalidate="" method="POST" action="{{route('addHODs')}}">
                          @csrf
                            <div class="form-row">
                              <div class="col-md-12 mb-3">
                                <label for="validationCustom01"> الاسم</label>
                                <input type="text" name='name_HOD' class="form-control" id="validationCustom01" value="" required="">
                                <div class="invalid-feedback">  يرجى إدخال الاسم الرباعي </div>
                              </div>
                              <div class="col-md-12 mb-3">
                                <label for="validationCustom04">القسم</label>
                                <select class="custom-select" name="department_HOD" id="validationCustom04" required="">
                                  <option selected disabled value=""> اختر... </option>
                                  <option value="1" >هندسة حاسوب </option>
                                  <option value="2" >هندسة إلكترونية </option>
                              ...
                              <div class="col-md-12 mb-3">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="email" name='mail' class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required="">
                    ...
                    <div id="dataTable-1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                      ...
                      <!-- <div class="row"> -->
                        ...
                        <tbody>
                          ...
                          @if (isset($showhods) && $showhods -> count() > 0)
                                   
                                   
                                       
                                   @foreach ($showhods as $showhod)
                                   
                                   <tr class="even">
                                     <td>{{++$d;}}</td>
                                     <td>{{$showhod->HOD_name}} </td>
                                     <td>{{$showhod->departments->dep_name}}</td>
                                     <td>{{$showhod->email}}</td>
                                     <td>
                                      <button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span class="text-muted sr-only">Action</span>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-row">
                      ...
                      <div class="col-md-6 mb-3">
                        <label for="validationCustom01"> القسم</label>
                        <input type="text" class="form-control" id="validationCustom01"  >
                      </div>
                      <div class="col-md-6 mb-3">
                        <label for="validationCustomUsername">الايميل</label>
