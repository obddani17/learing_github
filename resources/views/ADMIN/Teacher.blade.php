          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
                ...
                <li class="nav-item">
                  <a class="nav-link pl-3" href="./admin_i_t"><span class="ml-1 item-text">كارد تعليمي</span>
                  </a>
                </li>
                <li class="nav-item">
          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center mb-2">
                <div class="col">
                  <h2 class="h5 page-title">  الكادر التعليمي </h2>
                </div>
              </div>
                ...
                <div class="col-lg-12">
                  <div class="card shadow">
                    ...
                    <div id="dataTable-1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                      ...
                      <div class="row">
                          <div class="col-sm-12 " style="height: 300px; overflow-y:auto; overflow-x:auto">
                        ...
                        <thead class="">
                          <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="dataTable-1"  aria-label="#: activate to sort column ascending" style="width: 150px;">الاسم</th>
                            <th class="sorting" tabindex="0" aria-controls="dataTable-1"  aria-label="Name: activate to sort column ascending" style="width: 100px;">المؤهل التعليمي</th>
                            <th class="sorting" tabindex="0" aria-controls="dataTable-1"  aria-label="Phone: activate to sort column ascending" style="width: 100px;">الرقم</th>
                            <th class="sorting" tabindex="0" aria-controls="dataTable-1"  aria-label="Department: activate to sort column ascending" style="width: 120px;">الايميل</th>
                            <th class="sorting" tabindex="0" aria-controls="dataTable-1"  aria-label="Company: activate to sort column ascending" style="width: 80px;">تعديل</th>
                        </thead>
                        <tbody>
                          ...
                          @if (isset($showteachers) && $showteachers -> count() > 0)
                            @foreach ($showteachers as $showteacher)
                                   
                             <tr class="even">
                               <td>{{++$d;}}</td>
                               <td>{{$showteacher->tea_name}} </td>
                               <td> {{$showteacher->qualification}}</td>
                               <td>{{$showteacher->number}}</td>
              ...
              <form class="needs-validation" novalidate method="POST" action="{{route('updateteachers')}}">
                @csrf
                          ...
                          <div class="modal-body">
                              <div class="form-row">
                                <div class="col-md-6 mb-3">
                                  ...
                                  <input type="text" name='name_teacher' class="form-control" id="validationCustom01"  >
                                </div>
                                <div class="col-md-6 mb-3">
                                  <label for="validationCustom01"> المؤهل</label>
                                  <input type="text" name='qualifications' class="form-control" id="validationCustom01"  >
                                </div>
                                <div class="col-md-6 mb-3">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input type="email" name='mail' class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" >
                                  </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                  <label for="validationCustom02"> رقم التواصل</label>
                                  <input type="number" name='number' class="form-control" id="validationCustom02"  >
                                </div>
                              </div>
