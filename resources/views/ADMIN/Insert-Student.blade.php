                ...
                <div class="col-4">
                      <div class="card shadow mb-4">
                        <div class="card-header">
                          <strong class="card-title"> بيانات الطالب </strong>
                        </div>
                        <div class="card-body">
                          <form class="needs-validation" novalidate="">
                            <div class="form-row">
                              ...
                              <div class="col-md-12 mb-3">
                                ...
                                <div class="invalid-feedback">  يرجى إدخال رقم القيد </div>
                              </div>
                      ...
                      <!-- <div class="row"> -->
                        ...
                        <thead class="">
                          <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="dataTable-1"  aria-sort="ascending" aria-label=": activate to sort column descending" >رقم القيد </th>
                            <th class="sorting" tabindex="0" aria-controls="dataTable-1"  aria-label="#: activate to sort column ascending"  >الاسم</th>
                            <th class="sorting" tabindex="0" aria-controls="dataTable-1"  aria-label="Name: activate to sort column ascending" >التخصص </th>
                            <th class="sorting" tabindex="0" aria-controls="dataTable-1"  aria-label="Name: activate to sort column ascending" >المستوي </th>
                        ...
                        <tbody>
                          <tr role="row" class="odd">
                            ...
                            <td class="sorting_1">13857373846892</td>
